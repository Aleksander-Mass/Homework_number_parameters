...
def single_root_words(root_word, *other_words):
    # Приводим корневое слово к нижнему регистру для последующих сравнений
    ...
    for word in other_words:
        ...
        # Если root_word содержится в слове или слово содержится в root_word
        if root_word in word_lower or word_lower in root_word:
            same_words.append(word)  # Добавляем исходное слово (в исходном регистре)
...
result3 = single_root_words('num', 'Number', 'spasenum', 'HomeWork', 'paramNUMeters')
print(result3) # => ['Number', 'spasenum', 'paramNUMeters']

result4 = single_root_words('Name', 'Disname', 'Dinamo', 'namement', 'mailling')
print(result4) # => ['Disname', 'namement']

result5 = single_root_words('Право', 'NRправоWS', 'orпраВО', 'chПРАiesво', 'направо')
print(result5) # => ['NRправоWS', 'orпраВО', 'направо']